...
void solve()
{
    ...
    FORLL(i,1,n){
        cin >> t;
        a[t]++;
        if(a[t]==1) a1.insert(t);
        else if(a[t]==2) a2.insert(t),a1.erase(t);
    }
    FORLL(i,1,n){
        cin >> t;
        b[t]++;
        if(b[t]==1) b1.insert(t);
        else if(b[t]==2) b2.insert(t),b1.erase(t);
    }
    ll cnt2=min(a2.size(),b2.size());
    if(cnt2>=k){
        FORLL(i,1,k){
            ansa.push_back(*a2.begin());
            ansa.push_back(*a2.begin());
            ansb.push_back(*b2.begin());
            ansb.push_back(*b2.begin());
            a2.erase(a2.begin());
            b2.erase(b2.begin());
        }
        ...
        FORLL(i,1,k-cnt2){
            ansa.push_back(*a1.begin());
            ansb.push_back(*a1.begin());
            a1.erase(a1.begin());
            ansa.push_back(*a1.begin());
            ansb.push_back(*a1.begin());
            a1.erase(a1.begin());
    ...
    FORLL(i,0,2*k-1) cout << ansa[i] << Presentation(i,2*k-1);
    FORLL(i,0,2*k-1) cout << ansb[i] << Presentation(i,2*k-1);
}
/*----------Code Area----------*/
