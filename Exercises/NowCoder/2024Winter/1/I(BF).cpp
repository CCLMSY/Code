...
/*----------Code Area----------*/
#define N 100000
bool test(ll x,ll y,ll r){
    return x+r<=100&&x-r>=-100&&y+r<=100&&y-r>=-100;
}
void funbit(){
    ll sum=0,sum2=0,sumx=0,sumy=0;
    ll x,y,r;
    FORLL(i,1,N){
        x=rand()%199-99;
        y=rand()%199-99;
        r=rand()%100+1;
        while(test(x,y,r)==false){
            r=rand()%100+1;
        }
        sumx+=x;
        sumy+=y;
    ...
    cout << "bit:" << endl;
    cout << "avgx:" << sumx/N << endl;
    cout << "avgy:" << sumy/N << endl;
    cout << "avgrr:" << sum/N << endl;
    cout << "avgr2:" << sum2/N << endl;
    cout << endl;
}
void funbuaa(){
    ll sum=0,sum2=0,sumx=0,sumy=0;
